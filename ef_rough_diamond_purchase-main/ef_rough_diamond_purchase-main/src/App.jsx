...
const PARCEL_DEFS = [
  ...
  },
  {
    ...
    parcel: { date:"2026-03-16", viewing_date: "2026-03-22", tender:"ODC", number:"101", name:"+5+3 Gem SW", totalCts:59.41, pcs:0, lastSold:120, bidPrice:"", openingPrice:90, soldPrice:116, soldTotal:6897 },
    flu: [
      ...
      <div className="body">
        ...
        {tab === 0 && <>
          <div className="card">
            ...
            <div className="card-body">
              <div className="row">
                {[["Date","date",130,"date"],["Viewing Date","viewing_date",130,"date"],["Tender","tender",80],["#","number",50],["Name","name",200]].map(([l,k,w,t2]) =>
