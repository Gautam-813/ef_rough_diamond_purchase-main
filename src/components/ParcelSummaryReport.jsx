...
const ParcelSummaryReport = ({ parcel, tender, state, prices }) => {
  ...
  return (
    <div className="summary-report-container">
      ...
      {/* 6. FLUORESCENCE (MOCKED AS DATA IS NOT IN STATE YET) */}
      ...
      <table className="summary-table mini" style={{maxWidth:500}}>
         ...
         <tbody>
            <tr><td>None / Faint</td><td>{formatNum(totalRoughCts * 0.85, 2)}</td><td>85.0%</td></tr>
            <tr><td>Medium / Strong</td><td>{formatNum(totalRoughCts * 0.15, 2)}</td><td>15.0%</td></tr>
            <tr className="total-row"><td>TOTAL</td><td>{formatNum(totalRoughCts, 2)}</td><td>100.0%</td></tr>
         </tbody>
      </table>
